...
function AddeparAssetAllocationV2(props: Props) {
  ...
  const [addeparChartList, setAddeparChartList] = useState<DonutDataType[]>([]);
  ...
  return (
    <View style={styles.cardMain}>
      <View style={styles.orionAssetLay}>
        ...
        {props.data?.status == 1 ? (
          <View style={styles.addepAssetMain}>
            <View pointerEvents="none" style={styles.donutLay}>
              {addeparChartList.length > 0 && (
                <CustomDonut
                  data={addeparChartList}
...
const makeStyles = (theme: CustomTheme) =>
  StyleSheet.create({
    ...
    addepAssetMain: { flex: 1, justifyContent: 'center', alignItems: 'center' },
    donutLay: {
...
export default AddeparAssetAllocationV2;
